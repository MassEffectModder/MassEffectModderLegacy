...
static uLong ZCALLBACK iomem_write_func(voidpf opaque, voidpf stream, voidpc buf, uLong size)
{
	IOMEMHANDLE* ioMemHandle = stream;
...
static ZPOS64_T ZCALLBACK iomem_tell_func(voidpf opaque, voidpf stream)
{
	IOMEMHANDLE* ioMemHandle = stream;
...
static long ZCALLBACK iomem_seek_func(voidpf opaque, voidpf stream, ZPOS64_T offset, int origin)
{
	IOMEMHANDLE* ioMemHandle = stream;
...
static int ZCALLBACK iomem_close_func(voidpf opaque, voidpf stream)
{
	IOMEMHANDLE* ioMemHandle = stream;
