...
namespace MassEffectModder
{
    public partial class MipMaps
    {
        ...
        public string removeMipMapsME1(int phase, List<FoundTexture> textures,
            ...
            for (int i = 0; i < GameData.packageFiles.Count; i++)
            {
                ...
                if (modified)
                {
                    if (package.compressed && package.compressionType != Package.CompressionType.Zlib)
                        package.SaveToFile(forceZlib, false, false, null, installer != null);
                    else
                        package.SaveToFile(false, false, false, null, installer != null);
                }
                else
                {
                    package.Dispose();
        ...
        public string removeMipMapsME2ME3(List<FoundTexture> textures,
            MainWindow mainWindow, Installer installer, bool forceZlib = false)
        {
            string errors = "";
